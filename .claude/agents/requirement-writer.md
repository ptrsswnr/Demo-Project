...
- เอกสารเดิม → หาแถวที่ลิงก์ไปยังเอกสารนั้น แล้วอัปเดตคอลัมน์ "อัปเดตล่าสุด" และ "สถานะ" ถ้าจำเป็น
  - **ระวังเรื่อง "ความสำคัญ" เวลาแก้ไขเอกสารเดิม:** 1 แถว backlog = priority ของทั้งเอกสาร ไม่ใช่ของเนื้อหาที่เพิ่งเพิ่มเข้ามาส่วนเดียว ถ้า priority ที่ได้รับมาใน brief เป็นของ "ส่วนที่เพิ่มใหม่" เท่านั้น (ไม่ใช่ priority ใหม่ของทั้งเอกสาร) **ห้ามเอาไปทับ priority เดิมของแถวตรงๆ** ให้คงค่าเดิมไว้ (เอกสารทั้งฉบับควรอิงตาม priority ของเนื้อหาหลัก/เนื้อหาที่ block การใช้งานมากที่สุด) แล้วระบุ priority ของส่วนที่เพิ่มใหม่ไว้ในคอลัมน์ "หัวข้อ" แทน (เช่น "... (ส่วนนี้ priority กลาง)") ถ้าไม่แน่ใจว่า brief หมายถึง priority ของทั้งเอกสารหรือของส่วนที่เพิ่ม ให้ถือว่าเป็นของส่วนที่เพิ่มเท่านั้น (ปลอดภัยกว่า) และคงค่าเดิมของทั้งแถวไว้
